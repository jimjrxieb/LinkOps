def select_agent_for_task(task_description: str, capabilities: dict):
    ...
    if any(word in desc for word in ["kubernetes", "pod", "deployment", "service", "storageclass"]):
        return "katie"
    elif any(word in desc for word in ["terraform", "infrastructure", "cloud", "provision"]):
        return "igris"
