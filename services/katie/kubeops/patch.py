...
class KubernetesPatcher:
    ...
    def patch_deployment(
        ...
        try:
            ...
            if dry_run:
                return self._dry_run_patch_deployment(namespace, deployment_name, patch_data)
            ...
            current_deployment = self.apps_v1.read_namespaced_deployment(deployment_name, namespace)
    ...
    def patch_configmap(
        ...
        try:
            ...
            if dry_run:
                return self._dry_run_patch_configmap(namespace, configmap_name, patch_data)
            ...
            for container in containers:
                if "image" in container:
                    ...
                    if not self._validate_image_format(container["image"]):
                        validation["valid"] = False
                        validation["reason"] = f"Invalid image format: {container['image']}"
                        return validation
    ...
    def _dry_run_patch_deployment(self, namespace: str, deployment_name: str, patch_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _dry_run_patch_configmap(self, namespace: str, configmap_name: str, patch_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _dry_run_patch_service(self, namespace: str, service_name: str, patch_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _dry_run_apply_manifest(self, manifest_yaml: str, namespace: str) -> Dict[str, Any]:
    ...
    def _generate_patch_insight(self, resource_name: str, patch_data: Dict[str, Any], impact_analysis: Dict[str, Any]) -> str:
