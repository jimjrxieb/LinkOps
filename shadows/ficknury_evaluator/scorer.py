...
class TaskScorer:
    ...
    def score_task(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for logic_source, config in self.logic_sources.items():
                ...
                priority_score = self._calculate_priority_score(task_priority, logic_source)
            ...
            logger.info(f"Task scoring complete. Best: {result['best_logic_source']['logic_source'] if result['best_logic_source'] else 'None'}")
            return result
    ...
    def _calculate_capability_score(self, requirements: List[str], capabilities: List[str]) -> float:
    ...
    def _generate_recommendation(self, scores: List[Dict[str, Any]], task: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def get_logic_source_capabilities(self, logic_source: str) -> Optional[Dict[str, Any]]:
    ...
    def validate_task_requirements(self, requirements: List[str]) -> Dict[str, Any]:
        ...
        coverage_ratio = len(covered_requirements) / len(requirements) if requirements else 0
