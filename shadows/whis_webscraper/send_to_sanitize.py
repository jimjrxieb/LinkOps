...
class WhisSanitizeSender:
    ...
    def __init__(self, sanitize_service_url: str = "http://whis_sanitize:8003"):
        ...
        self.session.headers.update({
            ...
            'User-Agent': 'Whis-WebScraper/2.0'
        })

    def format_for_sanitize(self, scraped_data: Dict[str, List[Dict[str, Any]]]) -> List[Dict[str, Any]]:
    ...
    def send_to_sanitize(self, formatted_items: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        logger.info(f"Sanitize processing complete: {results['success_count']} success, {results['error_count']} errors")
        return results

    def send_batch_to_sanitize(self, scraped_data: Dict[str, List[Dict[str, Any]]]) -> Dict[str, Any]:
