...
class ServiceConnector:
    ...
    async def call_audit_assess_scan(self, repo_url: str, branch: str = "main") -> Dict[str, Any]:
        async with httpx.AsyncClient() as client:
            resp = await client.post(f"{self.assess_base}/repo/", json={"repo_url": repo_url, "branch": branch})
