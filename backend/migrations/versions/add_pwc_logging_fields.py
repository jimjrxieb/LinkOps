...
def upgrade():
    ...
    op.add_column('logs', sa.Column('sanitized', sa.Boolean(), nullable=False, server_default='false'))
    op.add_column('logs', sa.Column('approved', sa.Boolean(), nullable=False, server_default='false'))
    op.add_column('logs', sa.Column('auto_approved', sa.Boolean(), nullable=False, server_default='false'))
