...
class AgentLog(Base):
    ...
    logic_source = Column(String(100), nullable=True, index=True)  # igris_logic, katie_logic, etc.
    log_level = Column(String(20), nullable=False, index=True)  # INFO, WARNING, ERROR, DEBUG
    message = Column(Text, nullable=False)
    operation = Column(String(100), nullable=True, index=True)  # task_execution, enhancement, etc.
